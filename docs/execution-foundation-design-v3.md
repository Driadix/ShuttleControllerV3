...
- **Unknown**: фактическая длительность содержимого SafetySlot (реализация #71) - бюджет слота ≤ T_step проверяется на имплементации #71; #70 поставляет механизм и гарантию интервала ≤ T_step между вызовами.
